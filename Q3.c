...
/*Upon randomly freeing some of the allocated memory and then continuing to loop in the program, it was noticed that the freed memory addresses did get reallocated, as the address would be seen again in a future call to malloc*/
